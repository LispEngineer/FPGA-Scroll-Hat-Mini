...
module I2C_CONTROLLER #(
  ...
  input logic [REPEAT_SZ-1:0] data_repeat,
...
logic [REPEAT_SZ-1:0] k_data_repeat; // How many times to send the data byte again?
logic       k_read_two;
        ...
        if (byte_step == 4'd8 && step == 2'd3) begin
          ...
          if (is_write && !next_got_ack) begin
            ...
            if (k_data_repeat == 0 || !is_write) begin
              ...
              k_data_repeat <= k_data_repeat - (REPEAT_SZ)'(1);
            end
